...
import it.polito.ai.gas.web.DeliveryWithdrawalController;
...
privileged aspect DeliveryWithdrawalController_Roo_Controller {
    ...
    public String DeliveryWithdrawalController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String DeliveryWithdrawalController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("deliverywithdrawals", DeliveryWithdrawal.findDeliveryWithdrawalEntries(firstResult, sizeNo));
            float nrOfPages = (float) DeliveryWithdrawal.countDeliveryWithdrawals() / sizeNo;
    ...
    public String DeliveryWithdrawalController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
