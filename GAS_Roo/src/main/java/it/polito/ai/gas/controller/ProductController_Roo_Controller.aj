...
privileged aspect ProductController_Roo_Controller {
    ...
    public String ProductController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String ProductController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
