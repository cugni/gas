...
import it.polito.ai.gas.web.UsersController;
...
privileged aspect UsersController_Roo_Controller {
    ...
    void UsersController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("users_birthdate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
