...
import it.polito.ai.gas.web.ProductsController;
...
privileged aspect ProductsController_Roo_Controller {
    ...
    public String ProductsController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String ProductsController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Products.findProducts(id));
        return "productses/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ProductsController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void ProductsController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("products_availablefrom_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("products_availableto_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
